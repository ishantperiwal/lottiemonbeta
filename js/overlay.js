...
const n = 1; // Minimum allowed segment duration in frames
const segmentColors = [
  '#87d8c0', // Mint Green
  '#c5e0a5', // Pastel Olive
  '#ffb79a', // Soft Peach
...
function renderSegments() {
    ...
    segments.forEach(seg => {
        ...
        if (seg.name === 'Full Animation 2323') {
...
if (segmentIndex > -1) {
        ...
        if (deletedSegmentName && deletedSegmentName !== 'Full Animation 2323') {
 ...
 function handleApplyAndClose() {
    ...
    window.parent.postMessage({
        ...
        deletedSegmentNames: deletedSegmentNames // NEW: Send the list of deleted names
...
function updateOverlays() {
    ...
    segmentElements.forEach((segEl, index) => {
        ...
        if (index === 0) {
            ...
            if (segmentName === 'Full Animation 2323') {
                // Special overlay for "Full Animation"
                overlay.innerHTML = `<i class="fas fa-lock" style="margin-right: 8px;"></i> This segment cannot be edited`;
                overlay.classList.add('locked'); // This class now controls visibility and cursor
            } else {
                // Default overlay
